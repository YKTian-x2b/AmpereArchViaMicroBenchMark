...
// nvcc -gencode=arch=compute_86,code=\"sm_86,compute_86\" -I../Utils -L /usr/local/cuda/lib64 -l cuda -o res/globalMem_latency_YHs globalMem_latency_YHs.cu

// nvcc --keep --keep-dir latency_midRes_YHs -gencode=arch=compute_86,code=\"sm_86,compute_86\" -I../Utils -L /usr/local/cuda/lib64 -l cuda -o res/globalMem_latency_YHs globalMem_latency_YHs.cu
// cuasm --bin2asm latency_midRes_YHs/globalMem_latency_YHs.sm_86.cubin -o latency_midRes_YHs/globalMem_latency_YHs.sm_86.cuasm
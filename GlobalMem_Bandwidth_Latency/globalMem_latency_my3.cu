...
void doTest(){
    const uint32_t stride = 4*1024*256;
    const uint32_t arr_size = stride * (UNROLL+2);
...
// nvcc -gencode=arch=compute_86,code=\"sm_86,compute_86\" -I../Utils -L /usr/local/cuda/lib64 -l cuda -o res/globalMem_latency_my3 globalMem_latency_my3.cu

// nvcc --keep --keep-dir latency_midRes -gencode=arch=compute_86,code=\"sm_86,compute_86\" -I../Utils -L /usr/local/cuda/lib64 -l cuda -o res/globalMem_latency_my3 globalMem_latency_my3.cu
// cuasm --bin2asm latency_midRes/globalMem_latency_my3.sm_86.cubin -o latency_midRes/globalMem_latency_my3.sm_86.cuasm
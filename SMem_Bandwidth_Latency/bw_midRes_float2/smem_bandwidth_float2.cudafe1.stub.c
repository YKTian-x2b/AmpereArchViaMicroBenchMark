...
#include "smem_bandwidth_float2.fatbin.c"
...
# 42 "smem_bandwidth_float2.cu"
}
# 1 "bw_midRes_float2/smem_bandwidth_float2.cudafe1.stub.c"
static void __nv_cudaEntityRegisterCallback( void **__T9) {  __nv_dummy_param_ref(__T9); __nv_save_fatbinhandle_for_managed_rt(__T9); __cudaRegisterEntry(__T9, ((void ( *)(uint32_t *, uint32_t *, float *))SMem_writeBW_test_kernel), _Z24SMem_writeBW_test_kernelPjS_Pf, (-1)); }

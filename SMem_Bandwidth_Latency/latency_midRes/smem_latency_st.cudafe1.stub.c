...
#include "smem_latency_st.fatbin.c"
...
# 42 "smem_latency_st.cu"
}
# 1 "latency_midRes/smem_latency_st.cudafe1.stub.c"
static void __nv_cudaEntityRegisterCallback( void **__T4) {  __nv_dummy_param_ref(__T4); __nv_save_fatbinhandle_for_managed_rt(__T4); __cudaRegisterEntry(__T4, ((void ( *)(uint32_t *, uint32_t *, uint32_t *))smem_st_latency_test_kernel), _Z27smem_st_latency_test_kernelPjS_S_, (-1)); }

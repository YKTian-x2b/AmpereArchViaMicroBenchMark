...
// nvcc --keep --keep-dir bw_midRes_float4 -gencode=arch=compute_86,code=\"sm_86,compute_86\" -I../Utils -L /usr/local/cuda/lib64 -l cuda -o res/smem_bandwidth_float4 smem_bandwidth_float4.cu
// cuasm --bin2asm bw_midRes_float4/smem_bandwidth_float4.sm_86.cubin -o bw_midRes_float4/smem_bandwidth_float4.sm_86.cuasm
...
float L0CacheSize_test_run_drv(const float4 v, unsigned *startClk, unsigned *stopClk, float *out)
{
    ...
    if (!isInitialized)
    {
        ...
        cuModuleLoad(&cuModule, "midRes_my/L0_I-CacheSizeTest_my.sm_86.cubin");
...
// nvcc --keep --keep-dir midRes_my -gencode=arch=compute_86,code=\"sm_86,compute_86\" -I../../Utils -L /usr/local/cuda/lib64 -l cuda -o res/L0_I-CacheSizeTest_my L0_I-CacheSizeTest_my.cu

// cuasm --bin2asm midRes_my/L0_I-CacheSizeTest_my.sm_86.cubin -o midRes_my/L0_I-CacheSizeTest_my.sm_86.cuasm

// cp midRes_my/L0_I-CacheSizeTest_my.sm_86.cuasm res/L0_I-CacheSizeTest_my.template.sm_86.cuasm && cp midRes_my/L0_I-CacheSizeTest_my.sm_86.cuasm res/L0_I-CacheSizeTest_my.origin.sm_86.cuasm

// @CUASM_INSERT_MARKER_POS.

// python3 test_L0_I-Cache_my.py
...
// nvcc -gencode=arch=compute_86,code=\"sm_86,compute_86\" -I../../Utils -L /usr/local/cuda/lib64 -l cuda -o res/L2cacheBW_YHs L2cacheBW_YHs.cu

// nvcc --keep --keep-dir YHs_midRes -gencode=arch=compute_86,code=\"sm_86,compute_86\" -I../../Utils -L /usr/local/cuda/lib64 -l cuda -o res/L2cacheBW_YHs L2cacheBW_YHs.cu
// cuasm --bin2asm YHs_midRes/L2cacheBW_YHs.sm_86.cubin YHs_midRes/L2cacheBW_YHs.sm_86.cuasm
...
int main(){
    ...
    std::cout << "l2 cache access latency: " << clockCycles_avg << " cycles" << std::endl;
}

// nvcc -gencode=arch=compute_86,code=\"sm_86,compute_86\" -I../../Utils -L /usr/local/cuda/lib64 -l cuda -o res/l2Cache_latency_my2 l2Cache_latency_my2.cu

// nvcc --keep --keep-dir midRes -gencode=arch=compute_86,code=\"sm_86,compute_86\" -I../../Utils -L /usr/local/cuda/lib64 -l cuda -o res/l2Cache_latency_my2 l2Cache_latency_my2.cu
// cuasm --bin2asm midRes/l2Cache_latency_my2.sm_86.cubin midRes/l2Cache_latency_my2.sm_86.cuasm

// l2 cache access latency: 219 cycles
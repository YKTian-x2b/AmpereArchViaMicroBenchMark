...
def build(use_driver_api=True):
    cuasm2cubin('/opt/kaiProjects/MicroBenchmark/cache_Size_Throughput_Latency/L0_Cache_Size/L0CacheSizeTest.sm_86.cuasm')
...
def run_exe():
    try:
        res = subprocess.check_output('/opt/kaiProjects/MicroBenchmark/cache_Size_Throughput_Latency/L0_Cache_Size/L0CacheSizeTest')
        return res
...
def test_L0CacheSize(n_FFMA_seqs):
    ...
    cat.generate('/opt/kaiProjects/MicroBenchmark/cache_Size_Throughput_Latency/L0_Cache_Size/L0CacheSizeTest.sm_86.cuasm')
...
def doTest_L0CacheSize():
    with open('/opt/kaiProjects/MicroBenchmark/cache_Size_Throughput_Latency/L0_Cache_Size/save/res_L0CacheSize.txt', 'w') as fout:

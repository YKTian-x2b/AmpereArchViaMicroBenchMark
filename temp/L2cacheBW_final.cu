...
// 驱动调试
// nvcc --keep --keep-dir midRes -gencode=arch=compute_86,code=\"sm_86,compute_86\" -I../../Utils -L /usr/local/cuda/lib64 -l cuda -o res/L2cacheBW_final L2cacheBW_final.cu
// cuasm --bin2asm midRes/L2cacheBW_final.sm_86.cubin -o midRes/L2cacheBW_final.sm_86.cuasm
// rm midRes/*
// cuasm --asm2bin midRes/L2cacheBW_final.sm_86.cuasm -o midRes/L2cacheBW_final.sm_86.cubin 
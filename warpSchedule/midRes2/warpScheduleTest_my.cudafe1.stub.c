...
# 15 "warpScheduleTest_my.cu"
void warpSchedule_test_kernel( const struct float4 __cuda_0,unsigned *__cuda_1,unsigned *__cuda_2,float *__cuda_3)
# 16 "warpScheduleTest_my.cu"
{__device_stub__Z24warpSchedule_test_kernel6float4PjS0_Pf( __cuda_0,__cuda_1,__cuda_2,__cuda_3);
# 48 "warpScheduleTest_my.cu"
}
# 1 "midRes2/warpScheduleTest_my.cudafe1.stub.c"
static void __nv_cudaEntityRegisterCallback( void **__T12) {  __nv_dummy_param_ref(__T12); __nv_save_fatbinhandle_for_managed_rt(__T12); __cudaRegisterEntry(__T12, ((void ( *)(const struct float4, unsigned *, unsigned *, float *))warpSchedule_test_kernel), _Z24warpSchedule_test_kernel6float4PjS0_Pf, (-1)); }
